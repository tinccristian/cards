...
inline constexpr const char* PACEMAKER_STATUS_ICON = "assets/cards/pacemaker_status.png";
inline constexpr const char* SYNTHETIC_LUNG_STATUS_ICON = "assets/cards/synthetic_lung_status.png";
inline constexpr const char* HISTAMINE_STATUS_ICON = "assets/cards/histamine_status.png";
...
inline constexpr float HandCardEnterDuration   = 0.18f;  // seconds for newly drawn cards to fly into hand
inline constexpr float HandCardExitDuration    = 0.20f;  // seconds for played/discarded cards to fly to a pile
inline constexpr float PlayedCardDiscardDelay  = 1.00f;  // seconds a played card hangs before moving to discard
inline constexpr float ShuffleCardMoveDuration = 0.264f; // seconds for discard cards to fly back to draw pile
inline constexpr float HandDiscardStagger      = 0.025f; // seconds between end-turn hand discard ghosts
inline constexpr float DragVelocityTiltDegrees = 16.0f;  // extra tilt based on mouse movement while dragging
inline constexpr float DragTiltSpring          = 42.0f;  // spring strength for drag velocity tilt
inline constexpr float DragTiltDamping         = 13.0f;  // damping for drag velocity tilt
inline constexpr float MotionGhostTiltDegrees  = 18.0f;  // max velocity tilt for moving card ghosts
inline constexpr float MotionGhostTiltFactor   = 0.018f; // horizontal velocity to ghost tilt conversion
inline constexpr float MotionGhostTiltSpring   = 38.0f;  // spring strength for ghost velocity tilt
inline constexpr float MotionGhostTiltDamping  = 12.0f;  // damping for ghost velocity tilt
inline constexpr float InvalidCardShakeDuration = 0.24f; // seconds for unaffordable play shake
inline constexpr float InvalidCardShakePixels   = 9.0f;  // horizontal shake distance for unaffordable play
